                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: <Widget>[
                      ...
                      SizedBox(height: 10),
                      Container(width: MediaQuery.of(context).size.width, child: Text("Forgot Password?", textAlign: TextAlign.end, style: GoogleFonts.poppins(fontWeight: FontWeight.normal, fontSize: 14, color: headerColor))),
                      SizedBox(height: 30),
                      InkWell(
                        onTap: () {
                          Navigator.push(
                        ...
                        child: Container(
                          ...
                          child: Center(
                            child: Text("Sign In", style: GoogleFonts.poppins(fontWeight: FontWeight.normal, fontSize: 16, color: textColor)),
                          ),
                        ),
                      ),
                      SizedBox(height: 9),
                      Container(
                        ...
                        child: Row(mainAxisAlignment: MainAxisAlignment.center, children: <Widget>[
                          Text("New user?", style: GoogleFonts.poppins(fontWeight: FontWeight.normal, fontSize: 12, color: Colors.grey[600])),
                          SizedBox(width: 5),
                          Text("Create one", style: GoogleFonts.poppins(fontWeight: FontWeight.normal, fontSize: 12, color: headerColor)),
                        ]),
                      ),
                    ],
                  ),
